from ._anvil_designer import SprintBuscaTemplate
from anvil import *
...
class SprintBusca(SprintBuscaTemplate):
  ...
  def search(self, **event_args):
    ...
    filter = {
      ...
      'Release': self.release_drop_down.selected_value,
  ...
  def create(self, **event_args):
    RoutingUtils.set_url_hash('sprint/new', load_from_cache=False)
  ...
  def clear(self, **event_args):
    ...
    self.release_drop_down.selected_value = None
